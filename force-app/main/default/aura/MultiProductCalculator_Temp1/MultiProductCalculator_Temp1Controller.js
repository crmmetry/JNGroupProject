({
        ...
        for(var k in RequestData) {
            ...
            if(RequestData[k].colIndex=='Market'){
             ...
             IF(AND(M-y,I-P  ,O-Eori),PMT($F$89/12,SUM($L$89*12,$O$89),-$M$158),0))))))))*/
                ...
                if(cmp.find("Includeamoratoriumofloanrepayments").get("v.value")==0 && cmp.find("IndicateType").get("v.value")==2 && cmp.find("Otherpostmoratoriumoptions").get("v.value")==1){
                ...
                if(cmp.find("Includeamoratoriumofloanrepayments").get("v.value")==0 && cmp.find("IndicateType").get("v.value")==1 && cmp.find("Otherpostmoratoriumoptions").get("v.value")==1){
                    var n1=n-cmp.find("IndicateTerm").get("v.value");
                    var amla=0;
                ...
                if(cmp.find("Includeamoratoriumofloanrepayments").get("v.value")==0 && cmp.find("IndicateType").get("v.value")==2 && cmp.find("Otherpostmoratoriumoptions").get("v.value")==2){
                ...
                if(cmp.find("Includeamoratoriumofloanrepayments").get("v.value")==0 && cmp.find("IndicateType").get("v.value")==1 && cmp.find("Otherpostmoratoriumoptions").get("v.value")==2){
                    var amla=0;
    ...
    ShowHideOnIncludeamoratoriumofloanrepayments: function(cmp, evt, helper){
        ...
        switch(acMethod){
            case "0":
                ...
                $A.util.removeClass(cmp.find("Otherpostmoratoriumoptions"),"slds-hide");
    ...
    SaveData: function(cmp,evt,helper){
        ...
        var newCalculator = {
            ...
            'Market_Value_of_Vehicle__c': cmp.find("PurchasePriceofVehicle").get("v.value"),
            'Motor_Vehicle_Deposit__c': cmp.find("MotorVehicleDeposit4").get("v.value"),
            'Motor_Vehicle_Deposit_Percentage__c': cmp.find("MotorVehicleDeposit").get("v.value"),
            ...
            'Indicate_applicable_process_fee_percent__c':cmp.find("Indicateapplicableprocessingfees").get("v.value"),
            ...
            'Proposed_SavingsPercentage__c':cmp.find("ProposedSavings1").get("v.value"),
            ...
            'Unsecure_Indcate_applicable_process_fee__c':cmp.find("IndicateapplicableprocessingfeesUn").get("v.value"),
            'Unsecure_Loan_Savings_currency__c':'',
            'Unsecure_Proposed_Savings__c':cmp.find("ProposedSavings5Un").get("v.value"),
            'Unsecure_Proposed_Savings_percentage__c':cmp.find("ProposedSavings1Un").get("v.value"),
        ...
        action.setCallback(this,function(response){
            ...
            if(state == "SUCCESS"){
                ...
                var newCalculator = {'sobjectType': 'Loan_Calculator__c',
                                     'Product_Type__c':'',
                                     'Loan_Purpose__c': '',
