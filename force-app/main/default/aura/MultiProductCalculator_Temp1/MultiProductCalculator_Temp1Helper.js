...
IF(AND(M-y,I=P,O-Eori),PMT($F$89/12,SUM($L$89*12,$O$89),-$M$162),0))))))))*/
            ...
            if(cmp.find("Includeamoratoriumofloanrepayments").get("v.value")==0 && cmp.find("IndicateType").get("v.value")==2 && cmp.find("Otherpostmoratoriumoptions").get("v.value")==1 && cmp.find("IndicateTerm").get("v.value")==1){
                var n1=n-1;
            ...
            else if(cmp.find("Includeamoratoriumofloanrepayments").get("v.value")==0 && cmp.find("IndicateType").get("v.value")==2 && cmp.find("Otherpostmoratoriumoptions").get("v.value")==1 && cmp.find("IndicateTerm").get("v.value")==2){
                var n1=n-2;
                ...
                cmp.find("MonthlyJNGIMotorPremium1stYear2").set("v.value",  parseFloat(ajngid).toFixed(2));
                ...
                else if(cmp.find("Includeamoratoriumofloanrepayments").get("v.value")==0 && cmp.find("IndicateType").get("v.value")==2 && cmp.find("Otherpostmoratoriumoptions").get("v.value")==1 && cmp.find("IndicateTerm").get("v.value")==3){
                    var n1=n-3;
                    ...
                    cmp.set("v.MonthlyJNGIMotorPremium1stYear2New", ajngid);
                    cmp.find("MonthlyJNGIMotorPremium1stYear2").set("v.value",  parseFloat(ajngid).toFixed(2));
                } else if(cmp.find("Includeamoratoriumofloanrepayments").get("v.value")==0 && cmp.find("IndicateType").get("v.value")==2 && cmp.find("Otherpostmoratoriumoptions").get("v.value")==2 && cmp.find("IndicateTerm").get("v.value")==1){
                    var n1=n;
                    var AmortizationSC2C12=im*premium1styear;
                    var premium1styear1=parseFloat(premium1styear)+parseFloat(AmortizationSC2C12);
                    var ajngid=this.PMTcalculator(i,n1,premium1styear1);
                    ...
                    cmp.find("MonthlyJNGIMotorPremium1stYear2").set("v.value",  parseFloat(ajngid).toFixed(2));
                    ...
                    else if(cmp.find("Includeamoratoriumofloanrepayments").get("v.value")==0 && cmp.find("IndicateType").get("v.value")==2 && cmp.find("Otherpostmoratoriumoptions").get("v.value")==2 && cmp.find("IndicateTerm").get("v.value")==2){
                        var n1=n;
                        var AmortizationSC2C12=im*premium1styear*2;
                        var premium1styear1=parseFloat(premium1styear)+parseFloat(AmortizationSC2C12);
                        var ajngid=this.PMTcalculator(i,n1,premium1styear1);
                        ...
                        cmp.find("MonthlyJNGIMotorPremium1stYear2").set("v.value",  parseFloat(ajngid).toFixed(2));
                        ...
                        else if(cmp.find("Includeamoratoriumofloanrepayments").get("v.value")==0 && cmp.find("IndicateType").get("v.value")==2 && cmp.find("Otherpostmoratoriumoptions").get("v.value")==2 && cmp.find("IndicateTerm").get("v.value")==3){
                            var n1=n;
                            var AmortizationSC2C12=im*premium1styear*3;
                            var premium1styear1=parseFloat(premium1styear)+parseFloat(AmortizationSC2C12);
                            var ajngid=this.PMTcalculator(i,n1,premium1styear1);
                            ...
                            cmp.find("MonthlyJNGIMotorPremium1stYear2").set("v.value",  parseFloat(ajngid).toFixed(2));
                            ...
                            else if(cmp.find("Includeamoratoriumofloanrepayments").get("v.value")==0 && cmp.find("IndicateType").get("v.value")==1 && cmp.find("Otherpostmoratoriumoptions").get("v.value")==1){
                                ...
                                else if(cmp.find("Includeamoratoriumofloanrepayments").get("v.value")==0 && cmp.find("IndicateType").get("v.value")==1 && cmp.find("Otherpostmoratoriumoptions").get("v.value")==2){
            ...
            action.setCallback(this, function(response) {
                ...
                if (state === "SUCCESS") {
                    ...
                    if(cmp.find("InterestedinCreditorLife").get("v.value")=='0' && cmp.find("IncludeinLoanAmountinsurence").get("v.value")=='0' ){
                        ...
                        ///=====================
                        if(cmp.find("Includeamoratoriumofloanrepayments").get("v.value")==0 && cmp.find("IndicateType").get("v.value")==2 && cmp.find("Otherpostmoratoriumoptions").get("v.value")==1 && (cmp.find("IndicateTerm").get("v.value")==1 && cmp.find("IndicateTerm").get("v.value")==2 && cmp.find("IndicateTerm").get("v.value")==3)){
                            console.log("4 === ");
                        ...
                        else if(cmp.find("Includeamoratoriumofloanrepayments").get("v.value")==0 && cmp.find("IndicateType").get("v.value")==2 && cmp.find("Otherpostmoratoriumoptions").get("v.value")==2 && (cmp.find("IndicateTerm").get("v.value")==1 && cmp.find("IndicateTerm").get("v.value")==2 && cmp.find("IndicateTerm").get("v.value")==3)){
                            var n1=n;
                            var AmortizationSC2C12=im*jnlp*cmp.find("IndicateTerm").get("v.value");
                            console.log("4 im=== "+im);
