({
    GenrateScore : function(cmp,evt,helper,Empcategory,Empage,edu,res,ResidenceYr,CreditHis,Net_Worth,PoliticallyExposed,sanctionTrace,StatusOfEmployment,IndustryEmployment,LengthofCurrentEmployment,Professional_Category,CollateralType,LoanValue,AbilityService,Repayment_Method){
      ...
      /*
        ...
        */
        ...
        action.setParams({
            ...
            NegaticeTrace: cmp.find("sanctionScreeningResultedInNegativeTrace").get("v.value"),
